...
class Match(models.Model):
    ...
    # Penalty shootout scores (for knockout matches that end in a draw)
    home_penalties = models.PositiveIntegerField(null=True, blank=True, help_text="Home team penalty shootout score")
    away_penalties = models.PositiveIntegerField(null=True, blank=True, help_text="Away team penalty shootout score")
